            ...
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                                ...
                                <div className="mt-3 flex items-end justify-between gap-4">
                                    <div>
                                        <p className="text-2xl font-semibold">
                                            {dashboard
                                                ? `${dashboard.stats.fulfillmentRate.toFixed(1)}%`
                                                : "-"}
                                        </p>
                ...
                <section className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                    <StatsCard
                        ...
                        value={
                            dashboard
                                ? `Rp ${dashboard.stats.totalRevenue.toLocaleString("id-ID")}`
                                : "-"
                        }
                    ...
                    <StatsCard
                        ...
                        value={dashboard
                            ? dashboard.stats.totalOrders.toLocaleString("id-ID")
                            : "-"}
                    ...
                    <StatsCard
                        ...
                        value={dashboard
                            ? dashboard.stats.totalProducts.toLocaleString("id-ID")
                            : "-"}
