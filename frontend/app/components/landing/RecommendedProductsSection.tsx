...
import { ArrowRight, BadgeCheck, RefreshCw, Sparkles } from "lucide-react";
...
function getReasonVariant(reason?: string): ReasonVariant {
    if (!reason) return "default";
    const r = reason.toLowerCase();
    if (r.includes("sering dibeli bersama")) return "co-purchase";
    if (r.includes("pelengkap")) return "complementary";
    if (r.includes("mirip")) return "similar";
    if (r.includes("pilihan") || r.includes("acak")) return "random";
    return "default";
}
